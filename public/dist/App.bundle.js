...
var counter = (0, _bling.$)('.heart-count');
...
function makeMap(mapDiv) {
    ...
    autocomplete.addListener('place_changed', function () {
        ...
        var _ref = [place.geometry.location.lat(), place.geometry.location.lng()],
            lat = _ref[0],
            lng = _ref[1];
...
function typeAhead(search) {
    ...
    searchInput.on('input', (0, _utils.debounce)(performSearch.bind(searchInput), 200));
...
(0, _autocomplete.autoComplete)((0, _bling.$)('#address'), (0, _bling.$)('#lat'), (0, _bling.$)('#lon'));
